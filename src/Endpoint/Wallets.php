...
final class Wallets
{
    ...
    public function sendUsdc(float $amount, string $address, string $chain, string $customerEmail, string $description, string $reference): array {
    ...
    public function sendUsdt(float $amount, string $address, string $chain, string $customerEmail, string $description, string $reference): array {
